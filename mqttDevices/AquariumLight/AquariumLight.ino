...
// #define DEVICE_NAME "AquariumLight-d003885a"  // 小鱼缸灯v2.3 嘟嘟
#define DEVICE_NAME "AquariumLight-188eb6c9"  // 小鱼缸灯v2.3 客厅


// #define DEVICE_NAME "AquariumLight-test"
// #define CLIENT_ID "AquariumLight-d32016a7x"
#define CLIENT_ID "AquariumLight-188eb6c9"
...
void reconnectMqtt() {
  ...
  // platform change will do it in restoreStatus method
  // heater.doSubscribe();

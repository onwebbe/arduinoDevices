...
ICACHE_RAM_ATTR void isrx(void* arg) {
  ...
  HorerSensor8266* s = static_cast<HorerSensor8266*>(arg);
...
HorerSensor8266::HorerSensor8266(uint8_t horerPin) {
  PIN = horerPin;
  pinMode(PIN, INPUT_PULLUP);
}
void HorerSensor8266::init() {
...
HorerSensor8266::~HorerSensor8266() {
}
void HorerSensor8266::addGap(long gap) {
...
float HorerSensor8266::getAverageRPM() {
...
float HorerSensor8266::getLatestRPM() {
  autoPopulateZeroGap();
...
void HorerSensor8266::autoPopulateZeroGap() {
  _endTime = millis();
...
long* HorerSensor8266::getAllGaps() {
  return _gapList;
}

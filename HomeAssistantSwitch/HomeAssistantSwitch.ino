...
#define DEVICE_NAME "ESP8266Client-522b"
#define HEADBEAT_CHANNEL "homedevice/switch/ESP8266Client-522b/state"
#define SEND_CHANNEL "homedevice/switch/ESP8266Client-522b/set"
#define RECEIVE_CHANNEL "homedevice/switch/ESP8266Client-522b/set"
#define DISCOVER_CHANNEL "homedevice/switch/ESP8266Client-522b/config"

#define TARGET_COMMAND_CHANNEL "homedevice/switch/ESP8266Client-521b/set"
...
String CLIENT_ID = "ESP8266Client-522b";
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if ((char)payload[0] == '1') {
    ...
    client.publish(TARGET_COMMAND_CHANNEL, "1");
    ...
    client.publish(TARGET_COMMAND_CHANNEL, "0");
  }
...
void buttonClicked()
{
  ...
  client.publish(TARGET_COMMAND_CHANNEL, "10");
//  resetNetworkSettingsWhenFailed();
} // doubleClick
